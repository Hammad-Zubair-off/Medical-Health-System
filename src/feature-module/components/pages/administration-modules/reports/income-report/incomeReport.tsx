...
import { currentMonthRange } from "../../../../../../core/utils/report.utils";
import { getIncomeReport } from "../../../../../../core/services/firestore/report.service";
import { useReport } from "../hooks/useReport";
import DateRangeFilter from "../shared/DateRangeFilter";

const IncomeReport = () => {
  const fetcher = useCallback((range: { from: Date; to: Date }) => getIncomeReport(range), []);
  const { range, setRange, data, loading, error } = useReport(
    fetcher,
    currentMonthRange()
  );
  ...
  const columns = [
    {
      title: "Income",
      dataIndex: "Income",
      sorter: (a: { Income: string }, b: { Income: string }) =>
        a.Income.localeCompare(b.Income),
    },
    {
      title: "Amount",
      dataIndex: "Amount",
  ...
  return (
    <div className="page-wrapper">
      <div className="content">
        ...
        {loading && <div className="alert alert-info">Loading income…</div>}
          ...
          <>
            <div className="row mb-3">
              ...
              <div className="col-md-4">
                <div className="card shadow-sm">
                  <div className="card-body">
                    <p className="mb-1 text-muted">Payments</p>
